...
def create_file_response(*, path: str | Path, filename: str, media_type: str) -> StreamingResponse:
    ...
    res.raw_headers.append((b"Content-Disposition", f"attachment; filename*=utf-8''{quote(filename)}".encode('latin-1')))
    return res
